				...
				<div id="box">
					...
					<div class="">
						...
						<form id="form_add" name="form_add" method="post">
							...
							<div class="col-md-6">
							<label for="classAge" class="fw-bold">Lứa tuổi:<label class="lbStyle" id="lbclassAge" style="color:red; font-size:13px ; font-style: italic "></label></label>			
							...
							<div class="col-md-6">
							<label for="classTimeOpen" class="fw-bold">Thời gian bắt đầu khóa học:</label><label id="lbclassTimeOpen" style="color:red; font-size:13px ; font-style: italic "></label>
							<br>
							<input width="100%" type="date" id="classTimeOpen" name="classTimeOpen" placeholder="Nhập thời gian...">
							</div>
							...
							<br><select name="schedules0" id="schedules0">
								...
								<?php foreach ($result as $results) : ?>
									<option style="height: 30px;" <?php if (isset($_POST['schedules0']) && $_POST['schedules0'] == $results['MaLich']) echo 'selected' ?> value="<?php echo $results['MaLich']  ?>">
...
<script>
  ...
  <select style='' name="schedules${counter}" id="schedules${counter}">
          ...
          <?php foreach ($result as $results) : ?>
            <?php $counter = 1 ?>
            <option <?php if (isset($_POST['schedules']) && $_POST['schedules'] == $results['MaLich']) echo 'selected' ?>
